...
class Dashboard(customtkinter.CTk):
    ...
    def __init__(self, client: MountainClient):
        ...
        self.animacion_et = customtkinter.CTkLabel(self, text = "", text_color = "#FFFFFF", font = ("Verdana", 8), justify='left', anchor="w")
...
f' __\033[0m\n ║║██▄▄   ▄▄██▄▄ \033[0m\n ║║████████████\n ║║████████████\n ║║████████████\n ║║████████████\n ║║   ▀▀██▀▀   ▀▀\n ║║\n ║║\n ║║\n ║║\n ║║\n####\n'
        ...
        animacion_generada = [pyfiglet.figlet_format(frame, width=50) for frame in animacion]
